...
## 注意事项
0. **执行完某个方法后不要有多余的分析和思考**：直接告知是否成功，执行截图后输出示例：
`截图成功，保存路径：C:\data\tools\onmyoji-bot\tmp\screenshots\screenshot_20260531_214353.png`，
如果成功且有后续的步骤则可以省去输出，等待完整流程执行完毕后总结流程结果输出
